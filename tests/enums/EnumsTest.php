...
require_once 'src/enums/css/AngleUnit.php';
require_once 'src/enums/css/FrequencyUnit.php';
require_once 'src/enums/css/LengthUnit.php';
require_once 'src/enums/css/TimeUnit.php';
require_once 'src/enums/css/Media.php';
...
class EnumsTest extends TestCase
{
    ...
    public function provider(): array
    {
        return [
            ...
            [
                (new ImageType(ImageType::JPG))->getFilenameExtension(),
                'jpg'
            ],
            [
                ImageType::JPG()->getFilenameExtension(),
                'jpg'
            ],
            [
                Media::ALL(),
    ...
    {
        $this->assertEquals('aac', AudioType::AAC()->getFilenameExtension());
    }
}
